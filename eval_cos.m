...
x_g_a_B = bin2dec(x_g_a_B);
x_g_b_B = bin2dec(x_g_b_B);


y_g_a = -floor(bin2dec(rom_c1g(x_g_a_A+1,:))*x_g_a_B/128)+bin2dec(rom_c0g(x_g_a_A+1,:));
y_g_b = -floor(bin2dec(rom_c1g(x_g_b_A+1,:))*x_g_b_B/128)+bin2dec(rom_c0g(x_g_b_A+1,:));
